    ...
    <div className="min-h-screen bg-white text-ink selection:bg-primary/20">
      ...
      <main className="relative z-10 max-w-4xl mx-auto px-6 py-16 md:py-24 space-y-24">
        ...
        <section className="space-y-6">
          ...
          <div className="prose prose-lg text-[#55605B]">
            <p>
        ...
        <section className="space-y-12">
          <div className="text-center space-y-4">
            ...
            <p className="text-[#55605B] max-w-2xl mx-auto">
              Every tool we build is governed by these foundational principles.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-6">
            <div className="p-8 border border-black/10 bg-white shadow-sm shadow-black/[0.02] rounded-2xl space-y-4 hover:border-primary/30 hover:shadow-lg hover:shadow-black/5 transition-all">
              <div className="w-11 h-11 rounded-xl bg-mint border border-primary/20 flex items-center justify-center">
                <ShieldCheck className="w-5 h-5 text-primary" />
              </div>
              <h3 className="text-xl font-semibold">Privacy first</h3>
              <p className="text-[#55605B] leading-relaxed">
