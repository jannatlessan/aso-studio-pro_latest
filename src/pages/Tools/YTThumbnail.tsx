...
<div className="max-w-4xl mx-auto space-y-8">
  ...
  YouTube Thumbnail
           ...
           <p className="text-[#55605B] mt-4 text-lg">Download max-resolution cover imagery directly.</p>
        </div>

        <div className="glass-panel p-6 sm:p-8 rounded-3xl border border-black/10 bg-white shadow-sm shadow-black/[0.02]">
           <div className="flex flex-col sm:flex-row gap-4">
              <input
                ...
                className="flex-1 bg-[#F6F8F7] border border-black/10 rounded-xl p-4 text-ink focus:outline-none focus:border-primary text-lg"
              />
              <button onClick={handleFetch} className="bg-primary text-white px-8 py-4 sm:py-0 rounded-xl font-bold flex justify-center items-center gap-2 hover:bg-primary-dark transition-colors text-lg">
           ...
           {thumbUrl && !error && (
             <div className="mt-12 space-y-8 flex flex-col items-center animate-in fade-in slide-in-from-bottom-8 duration-500">
                <div className="relative group rounded-2xl overflow-hidden shadow-xl shadow-black/[0.06] border border-black/10">
                   <img src={thumbUrl} alt="Thumbnail Max Res" className="w-full object-cover" />
                </div>

                <div className="flex flex-wrap justify-center gap-4 w-full">
                  <a href={thumbUrl} target="_blank" rel="noreferrer" className="flex-1 max-w-[300px] flex justify-center bg-primary text-white px-6 py-4 rounded-xl font-black text-lg gap-3 hover:bg-primary-dark transition-all hover:scale-105">
                     <ExternalLink size={24} /> Open Max-Res
                  </a>
                  <a href={hqThumbUrl} target="_blank" rel="noreferrer" className="flex-1 max-w-[300px] flex justify-center bg-[#F6F8F7] text-ink border border-black/10 px-6 py-4 rounded-xl font-bold text-lg gap-3 hover:bg-black/[0.04] transition-all">
          ...
          <div className="max-w-4xl mx-auto mt-16 mb-8 px-4">
            <article className="glass-panel p-6 sm:p-8 rounded-2xl bg-white border border-black/10 shadow-sm shadow-black/[0.02] space-y-6 text-sm sm:text-base text-[#55605B] leading-relaxed font-sans">
              <h2 className="text-xl sm:text-2xl font-semibold text-ink">YouTube Thumbnail Downloader</h2>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <strong className="text-ink block mb-1">1. Is downloading a thumbnail legal?</strong>
                ...
                <div>
                  <strong className="text-ink block mb-1">2. Why is the image blurry for some older videos?</strong>
                ...
                <div>
                  <strong className="text-ink block mb-1">3. Can this download private video thumbnails?</strong>
            ...
            <section className="mt-12 mb-6"><h3 className="text-2xl font-bold text-ink font-mono border-b border-black/10 pb-4 mb-6">Best Practices for Usage & SEO</h3><div className="grid grid-cols-1 md:grid-cols-2 gap-4"><div className="space-y-4 rounded-lg bg-[#F6F8F7] p-6 border border-black/10"><h4 className="font-bold text-ink mb-2">Fair Use Application</h4><p className="text-[#55605B]">Only use extracted graphical imagery for commentary, transformative work, or personal offline archiving.</p></div><div className="space-y-4 rounded-lg bg-[#F6F8F7] p-6 border border-black/10"><h4 className="font-bold text-ink mb-2">Know Format Fallbacks</h4><p className="text-[#55605B]">If the Max-Res endpoint returns a hollow gray graphic, gracefully degrade to attempt the High-Qual standard instead.</p></div></div></section></article>
