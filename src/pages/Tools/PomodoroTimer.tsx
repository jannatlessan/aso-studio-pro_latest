...
<div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="text-center mt-12 mb-8">
          <div className="inline-flex bg-white/5 border border-white/10 p-2 rounded-2xl gap-2">
            <button onClick={() => setTimer(25, 'focus')} className={`px-6 py-3 rounded-xl font-bold flex items-center gap-2 transition-all ${mode === 'focus' ? 'bg-primary text-white shadow-lg scale-105' : 'text-white/50 hover:bg-white/10'}`}>
        ...
        <div className="glass-panel p-10 md:p-20 rounded-[3rem] border border-white/10 bg-black/40 text-center relative overflow-hidden group shadow-2xl">
          ...
          <div className="flex justify-center gap-6">
            <button onClick={toggle} className="bg-primary text-white px-12 py-5 rounded-2xl font-black flex items-center gap-3 hover:bg-white hover:text-black transition-all hover:scale-105 text-2xl shadow-xl">
      ...
      <div className="max-w-4xl mx-auto mt-16 mb-8 px-4">
            <article className="glass-panel p-6 sm:p-8 rounded-2xl bg-black/30 border border-white/5 space-y-6 text-sm sm:text-base text-white/70 leading-relaxed font-sans">
              <h2 className="text-xl sm:text-2xl font-semibold text-white">Focus-Enhancing Pomodoro Timer</h2>
